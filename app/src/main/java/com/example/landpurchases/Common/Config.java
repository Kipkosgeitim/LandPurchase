...
public class Config {
    public static final String PAYPAL_CLIENT_ID ="AeS5jdzhuXXR9ZyjCEZ-OIjbyZXPW7iveLCZXNkUQlE1cc9gFEKEiXkRSHjcts-Z7z3tPu6WQ6bF5_j2";
    ...
    public static final String CALLBACKURL = "https://malezi.co.ke/mpesa";
